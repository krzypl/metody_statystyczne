...
## test F na testowanie wariancji

$$
F = \frac{s_1^2}{s_2^2}
$$
gdzie $s_1^2$ to wariancja pierwszej próby, a $s_2^2$ to wariancja drugiej próby  

## analiza wariancji (ANOVA)

\(F-test = \frac{MS_A}{MS_E}\)

wariancja pomiędzy próbami = \(MS_A = \frac{SS_A}{m - 1}\)  
...
gdzie $N$ to całkowita liczba obserwacji, $m$ to liczba grup, a $\overline{\overline{X}}$ to średnia ze średnich
